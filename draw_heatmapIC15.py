...
with open('vis/results_IC15_BLSTM.json', 'r') as f:
    data = json.load(f)
print(data)
captions = data['captions']

imagePathDir='../Dataset/IC15Inc_WordRecognition/ch4_test_word_images_gt/'
labelfile =open('../Dataset/IC15Inc_WordRecognition/ch4_test_word_images_gt/annotation_gt.txt')
i=0
while 1:
